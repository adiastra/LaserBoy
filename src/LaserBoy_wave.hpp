...
public:
    ...
    LaserBoy_wave_header    (std::fstream& in                       );
    //------------------------------------------------------------------------
   ~LaserBoy_wave_header()
    {}
    //------------------------------------------------------------------------
...
public:
    ...
    //------------------------------------------------------------------------
    LaserBoy_wave_sample(const LaserBoy_wave_sample& sample)
   ...
   ~LaserBoy_wave_sample()
    ...
    //------------------------------------------------------------------------
    bool from_fstream_wave_inverted(std::fstream& in)
    {
        if(in.good())
        {
            in.read((char*)channel, num_channels * sizeof(signed short));
    ...
    //------------------------------------------------------------------------
    bool from_fstream_wave_polarity(std::fstream& in, int polarity[8])
    {
        if(in.good())
        {
            in.read((char*)channel, num_channels * sizeof(signed short));
    ...
    //------------------------------------------------------------------------
    bool from_fstream_wave_bit_resolution(std::fstream& in, u_int signal_bit_mask[8])
    {
        if(in.good())
        {
            in.read((char*)channel, num_channels * sizeof(signed short));
    ...
    //------------------------------------------------------------------------
    void to_fstream_wave(std::fstream& out, LaserBoy_wave_header& header)
    {
    ...
    //------------------------------------------------------------------------
    void to_fstream_wave_inverted(std::fstream& out, LaserBoy_wave_header& header)
    {
        negate();
        out.write((char*)channel, num_channels * sizeof(signed short));
        negate();
