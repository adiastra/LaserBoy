...
#define BMP_IMPOSSIBLE_OVERFLOW  -1
#define BMP_POSSIBLE_OVERFLOW     1
#define BMP_OK                    0
...
{                               //  defaults     offset
    ...
    u_int*    palette         ; //  null        ?? :                |
    u_char*   image           ; //  null        ?? :                |
    u_char**  uchar_row       ; //  null        ?? :                |
    u_short** ushort_row      ; //  null        ?? :                |
    u_int**   uint_row        ; //  null        ?? :                |
    // function pointers
...
void        bmp_scale_into_bmp     (struct LaserBoy_bmp* target, struct LaserBoy_bmp* source, double scale);
