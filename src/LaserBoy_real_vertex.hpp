...
public:
   ...
   ~LaserBoy_real_vertex()
    ...
    //------------------------------------------------------------------------
    LaserBoy_real_vertex& operator = (const LaserBoy_color& c) // only assign the colors
    {
        r = c.r;
        g = c.g;
        b = c.b;
    ...
    //------------------------------------------------------------------------
    LaserBoy_color     as_color    () const {  return     (LaserBoy_color)(*this); }
